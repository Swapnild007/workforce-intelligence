...
if(f.actual.length!==21 || f.forecast.length!==12 || !Number.isFinite(f.mae)) throw new Error('Forecast engine failed');
...
if(s.required.length!==48 || s.coverage.length!==48) throw new Error('Schedule engine failed');
