...
const handledButton = /data-(?:enter|view|view-go|lesson|decision|resource|more-view|search|content-lesson|row-dir)(?:=|\s|>)|id="(?:notifyBtn|decisionBtn|moreBtn|modalClose|modalAction)"/;
