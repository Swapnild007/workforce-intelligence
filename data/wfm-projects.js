...
(() => {
  ...
  function erlangProject(){
    ...
    return projectHead('Erlang Staffing Calculator','A browser-native version of the core Erlang staffing workflow: interval demand → workload → staffing → service level → occupancy → shrinkage. Includes an abandonment-aware Erlang-A view.','TOOL 01 · QUEUEING')+
  ...
  function capacityProject(){
    ...
    return projectHead('Capacity Planning Workbook','Convert weekly demand and AHT into workload hours, productive capacity and FTE. Then stress-test shrinkage instead of hiding it in one number.','TOOL 02 · CAPACITY')+
  ...
  function forecastProject(){
    ...
    return projectHead('Forecasting Studio','Convert the monthly forecasting spreadsheet idea into an interactive, data-driven browser project. Paste a series or use the built-in example, then inspect level, trend, seasonality and forecast error.','TOOL 03 · FORECASTING')+
  ...
  function adherenceProject(){
    ...
    return projectHead('Schedule Adherence Workbook','A web version of the scheduled-vs-actual adherence workflow. Edit individual agent minutes and see team and individual adherence immediately.','TOOL 04 · ADHERENCE')+
  ...
  function dashboardProject(){
    ...
    return projectHead('Contact Centre KPI Dashboard','A browser-native balanced scorecard inspired by the dashboard template: enter operational KPIs, compare them with targets and surface exceptions.','TOOL 05 · EXECUTIVE DASHBOARD')+
  ...
  function render(root){
    ...
    root.innerHTML='<div class="wfp-shell">'+projectHead('WFM Toolbox','Interactive browser tools based on the core forecasting, staffing, capacity, adherence, dashboard and multichannel workflows documented by Call Centre Helper. Excel is the reference workflow; Workforce Intelligence is the implementation.','WFM PROJECT SUITE')+
